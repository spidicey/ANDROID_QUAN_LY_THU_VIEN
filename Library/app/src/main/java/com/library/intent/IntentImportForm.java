...
import com.library.intent.form.import_form.FormImportFormCreate;
...
public class IntentImportForm extends AppCompatActivity implements ImportFormAdapter.OnItemClickListener {
    private final List<ImportForm> dataStorage = new ArrayList<>();
    private SearchView svSearchBar;
    private FloatingActionButton btnCreate;
    private RecyclerView rvMainDisplay;
    private ImportFormAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.intent_import_form);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("QUẢN LÝ PHIẾU NHẬP");
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        else if (itemId == R.id.mReload) ImportFormService.listImportForm(adapter, dataStorage);
    ...
    private void setControl() {
        ...
        this.adapter = new ImportFormAdapter(this);
    ...
    private void setEvent() {
        this.btnCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(v.getContext(), FormImportFormCreate.class));
            }
        });
    ...
    protected void onResume() {
        super.onResume();
        // REFRESH.
        ImportFormService.listImportForm(adapter, dataStorage);
    }

    @Override
    public void onItemClick(View view, int position) {
        Intent intent = new Intent(view.getContext(), FormImportFormModify.class);
    ...
    public void onItemLongClick(View view, int position) {
        ImportForm form = adapter.getItem(position);
        ...
        btnComplete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImportFormService.completeImportForm(form.getId());
                dialog.dismiss();
            }
        });
        btnCancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ImportFormService.deleteImportForm(form.getId());
                dialog.dismiss();
            }
        });
    ...
    private Dialog getDialog(View view) {
        Dialog dialog = new Dialog(IntentImportForm.this);
