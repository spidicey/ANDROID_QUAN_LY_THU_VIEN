...
public class FormBookModify extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.form_book_modify);
    ...
    private void setDataIntent() {
        ...
        this.book = (Book) intent.getSerializableExtra("item");
    }
    ...
    private void setData() {
        ...
        Glide.with(this).load(book.getImage()).into(imageView);
        eTitle.setText(book.getTitle());
        eAuthor.setText(book.getAuthor());
        eType.setText(book.getCategory());
        eBookshelf.setText(String.valueOf(book.getBookshelf()));
        eBookend.setText(String.valueOf(book.getShelf()));
        // SET ADAPTER.
        ...
        btnThem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (eTitle.getText().toString().trim().isEmpty()) {
                    Toast.makeText(FormBookModify.this, "Tên sách không thể trống!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (eAuthor.getText().toString().trim().isEmpty()) {
                    Toast.makeText(FormBookModify.this, "Tác giả không thể trống!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (eType.getText().toString().trim().isEmpty()) {
                    Toast.makeText(FormBookModify.this, "Thể loại không thể trống!", Toast.LENGTH_SHORT).show();
                    return;
                }
