...
public class GraphBookType extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.statistic_graph_book_type);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("PHÂN BỐ THỂ LOẠI SÁCH");
    ...
    private void setControl() {
        ...
        this.chart = findViewById(R.id.chartBookType);
    }

    private void setData() {
        StatisticService.graphBookType(chart);
        this.btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    File yourFile = new File(file + "PHAN_BO_THE_LOAI_SACH.pdf");
                ...
                Toast.makeText(GraphBookType.this, "Lưu thành công!", Toast.LENGTH_SHORT).show();
                document.close();
            }
        });
    }
