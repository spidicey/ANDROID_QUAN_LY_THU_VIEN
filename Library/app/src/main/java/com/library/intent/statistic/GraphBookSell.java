...
public class GraphBookSell extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.statistic_graph_book_sell);
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("THANH LÝ HÀNG THÁNG");
    ...
    private void setControl() {
        ...
        this.chart = findViewById(R.id.chartBookSell);
    }

    private void setData() {
        StatisticService.graphBookSell(chart);
        this.btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    File yourFile = new File(file + "THONG_KE_THANH_LY_SACH.pdf");
                ...
                Toast.makeText(GraphBookSell.this, "Lưu thành công!", Toast.LENGTH_SHORT).show();
                document.close();
            }
        });
    }
